...
def rodar_servidor_web():
    ...
    # DESATIVADO RELOADER: Impede o Flask de duplicar o processo do bot na inicialização
...
if __name__ == "__main__":
    try:
        ...
        print(f"FALHA CRÍTICA NA INICIALIZAÇÃO DO MAIN: {startup_err}")