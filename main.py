        ...
        try:
            ...
            if jogos and chat_id:
                ...
                for j in jogos:
                    ...
                    # 4. Alerta de 1 Hora - MODELAGEM DINÂMICA COM TRADUÇÕES APLICADAS (1 hora antes do início)
                    elif 50 <= minutos_restantes <= 60 and not ALERTAS_ENVIADOS[match_id]["1h"]:
                        # TRADUZ OS DADOS DAS EQUIPES ANTES DE ENVIAR AO GEMINI
                        ...
                        print(f"[AGENDADOR] Gerando Dossiê Técnico atualizado para {mandante_pt} x {visitante_pt}...")
                        ...
                        prompt = (
                            f"Crie um Dossiê Técnico Completo de Inteligência para a partida {mandante_pt} x {visitante_pt} pela liga {liga_pt}.\n"
                ...
                # Dispara mensagem agrupada para os jogos de 3 horas com tradução aplicada
                if jogos_3h_pendentes:
                    nomes_jogos = " e ".join([
                        f"{analisador.traduzir_nome(jg['mandante'])} x {analisador.traduzir_nome(jg['visitante'])}" 
                ...
                # Dispara mensagem agrupada para os jogos de 2 horas com tradução aplicada
